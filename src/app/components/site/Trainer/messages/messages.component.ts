...
export class MessagesTComponent implements OnInit {
  ...
  id:any;
   ...
   privatemsgs : any;
  name:any;
   constructor(private router:Router,private route: ActivatedRoute, private auth:AuthentificationService,private notifyService: NotifyService,private msgservice:MessagesService) { 
